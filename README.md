...
[Bats Evaluation Process](https://github.com/nholuongut/bats/wiki/Bats-Evaluation-Process)
on the wiki.
...
Bats. For example, to install Bats into `/usr/local`,
    ...
    $ git clone https://github.com/nholuongut/bats.git
    $ cd bats
...
GitHub](https://github.com/nholuongut/bats). There you can file bugs
...
[Projects Using Bats](https://github.com/nholuongut/bats/wiki/Projects-Using-Bats)
on the wiki.

To learn how to set up your editor for Bats syntax highlighting, see
[Syntax Highlighting](https://github.com/nholuongut/bats/wiki/Syntax-Highlighting)
on the wiki.
